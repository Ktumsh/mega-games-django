      ...
      <div id="responsive_page_menu" class="responsive_page_menu">
        <div class="mainmenu_contents">
          <div class="mainmenu_contents_items">
            ...
            <a class="menuitem supernav isLogged" href="/cart">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                <g fill="none">
...
`;
    ...
    if (isAuthenticated) {
      ...
      document.getElementById("session_link").style.display = "none";
      document.getElementById("account_pulldown").style.display = "inline";
    } else {
      document.getElementById("account_pulldown").style.display = "none";
    ...
    <div class="responsive_header_content">
      ${
        currentPath === "/login" || currentPath === "/join"
          ? ""
          : `<div id="responsive_menu_logo"><img src="https://store-megagames.onrender.com/assets/public/icons/header_menu_hamburger.webp" height="100%" /></div>`
      }
      ...
      footerContainer = `
        <footer id="footer" class="footer_page">
          <div class="footer_payment">
            <ul>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/wallet.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/logo_steam_footer.png" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/dlocal_webpay.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/braintree_paypal.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/dlocal_credit_card.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/ebanx_servipag_voucher.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/ebanx_sencillito_voucher.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/ebanx_multicaja_voucher.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/ebanx_machpay_wallet.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/boa_cl_transfer.svg" alt="" loading="lazy"></li>
              <li><img src="https://store-megagames.onrender.com/assets/public/payments/nuvei_crypto.svg" alt="" loading="lazy"></li>
            </ul>
          </div>
    ...
    function closeMenu() {
      if (hamburgerMenuSlot.classList.contains("mainmenu_active")) {
        ...
        if (hamburgerMenuOpenBtn.classList.contains("chevron")) {
          ...
          hamburgerMenuOpenBtn.innerHTML = `<img src="https://store-megagames.onrender.com/assets/public/icons/header_menu_hamburger.webp" height="100%" />`;
        }
